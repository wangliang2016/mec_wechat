...
var model= require('../model/wechat_subscriber_activity.json');
var table = sequelize.define('wechat_subscriber_activity',model,{freezeTableName:true,createdAt:false,updatedAt:false});
...
exports.queryOrCreate = function(qry,cb){
    table.findOrCreate(qry).spread(function(msg,created){
        cb(null,msg.get({plain:true}));
    },function (err) {
        cb(err,null);
    });
};
