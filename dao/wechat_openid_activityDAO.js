...
var model= require('../model/wechat_openid_activity.json');
var table = sequelize.define('wechat_openid_activity',model,{freezeTableName:true,createdAt:false,updatedAt:false});
